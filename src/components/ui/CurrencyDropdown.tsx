...
import { currencies, getCurrencyData, CurrencyMark } from "../../lib/currencyUtils";
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="flex items-center gap-3">
          {selectedCurrency ? (
            <>
              <CurrencyMark currencyId={selectedCurrency.id} size={18} className={selectedCurrency.color} />
          ...
          <div className="max-h-60 overflow-y-auto custom-scrollbar">
            {filteredCurrencies.length > 0 ? (
              filteredCurrencies.map((c) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <CurrencyMark currencyId={c.id} size={16} className={value === c.id ? c.color : "text-slate-400 group-hover:text-emerald-500"} />
